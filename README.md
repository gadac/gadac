...
<p></p>
Por fim, registro que obtive êxito em implementar API Resful usando Node.js com Javascript, PostgreSQL, JWT Token, Bcriptn, Nodemon e Express. A comunicação com o front-end foi feito em JSON
</p>
